<%@ Page Language="C#" AutoEventWireup="true" CodeFile="doacoes.aspx.cs" Inherits="doacoes" %>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <section class="doacoeshead">
                ...
                <h4 class="col-10 col-sm-5"> Procure aqui a instituição que você tem interesse em ajudar. </h4>
                <input type="text" class="form-control barrapesquisa z-index col-10 col-sm-5 mt-3" placeholder="Pesquisar instituições"/>
            </section>
        </section>

        <!-- INSTITUIÇÕES -->
        <section class="col-12 instituicoes animatedParent">
            <h3 class="animated fadeIn" align="center"> INTITUIÇÕES EM DESTAQUE </h3>
            <a href="" class="nav-link"><div class="shadow col-11 col-lg-10 insti p-2 mt-5 row">
                <img src="../images/graacc.png" class="img iconinsti ml-4" alt="Alternate Text"/>
                <h2 class="col-5 col-sm-8 col-lg-9 pl-3 pt-4 bold instname"> GRAACC </h2>
                <div class="btn-bolinha mt-3 shadow"></div>
            </div></a>
            <a href="instituicao.aspx" class="nav-link"><div class="shadow col-11 col-lg-10 insti p-2 mt-5 row">
                <img src="../images/aldeianissi.png" class="img iconinsti ml-4" alt="Alternate Text" align="center"/>
                <h2 class="col-5 col-sm-8 col-lg-9 pl-3 pt-4 bold instname"> ALDEIA NISSI </h2>
                <div class="btn-bolinha mt-3 shadow"></div>
            </div></a>
            <a href="" class="nav-link"><div class="shadow col-11 col-lg-10 insti p-2 mt-5 row">
                <img src="../images/hand.png" class="img iconinsti ml-4" alt="Alternate Text"/>
                <h2 class="col-5 col-sm-8 col-lg-9 pl-3 pt-4 bold instname"> IDOSOS ESPERANÇA </h2>
                <div class="btn-bolinha mt-3 cor3 shadow"></div>
            </div></a>
            <a href="" class="nav-link"><div class="shadow col-11 col-lg-10 insti p-2 mt-5 row">
                <img src="../images/greenpeace.png" class="img iconinsti ml-4" alt="Alternate Text"/>
                <h2 class="col-5 col-sm-8 col-lg-9 pl-3 pt-4 bold instname"> GREENPEACE </h2>
                <div class="btn-bolinha mt-3 cor4 shadow"></div>
            </div></a>
            <a href="" class="nav-link"><div class="shadow col-11 col-lg-10 insti p-2 mt-5 row">
                <img src="../images/crionca.png" class="img iconinsti ml-1" alt="Alternate Text"/>
                <h2 class="col-5 col-sm-8 col-lg-9 pl-3 pt-4 bold instname"> CRIANÇA ESPERANÇA </h2>
                <div class="btn-bolinha mt-3 shadow"></div>
            </div></a>
        </section>
